...
const ExperienceCard = ({ experience, darkMode }: any) => {
  return (
    ...
    >
      <div>
        <h3
          className={`text-[2.5vmin] sm:text-[2vmin] lg:text-[18px] font-bold ${
        ...
        <p
          className={`text-[2.5vmin] sm:text-[2vmin] lg:text-[16px] font-semibold ${
            darkMode ? 'text-[##eae0d7]' : 'text-[#1e1e1e]'
          }`}
          style={{ margin: 0 }}
        >
        ...
        {experience.points.map((point: any, index: any) => {
          return (
            <li
              ...
              className={`text-[2.5vmin] sm:text-[2vmin] lg:text-[1vmin] xl:text-[14px] pl-1 tracking-wider font-semibold text-[#1e1e1e]
              `}
            >
              {point}
            </li>
  ...
  return (
    ...
    >
      <div className="flex self-end">
        ...
        `}
          href="https://drive.google.com/file/d/1EjuoUpqehKWLfxlwkn4-qF1teaRYh0gx/view?usp=sharing"
          target="_blank"
        >
          Full Resume
        </Link>
